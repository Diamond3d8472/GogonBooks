...
if(isset($_SESSION['usuarioNiveisAcessoId']) && $_SESSION['usuarioNiveisAcessoId'] == "1" ){
	...
	include("conexao.php");
	$result_usuarios = "SELECT * FROM usuariosgo";
...
<div class="container">
            <div class="card border-0 shadow my-3">
                ...
                <div class=" col-md-12 text-center">   
                    ...
                    <h1 class="font-weight-light">Usuarios Cadastrados</h1>
                    </br>
                </div>
					...
					?> 
						<tr>
							<td><?php echo ''.$row_usuario['ID_User'];?></td>
							<td><?php echo ''.$row_usuario['nome'];?></td>
							<td><b><?php echo ''.$row_usuario['username'];?></b></td>
							<td style="text-align: center;"><a href="Show/Usuario/del.php?user=<?php echo $row_usuario['ID_User']; ?>" type="button" class="btn btn-default btn-danger" aria-label="Excluir livro">
                                   Excluir<span class="glyphicon glyphicon-remove"></span></a>
                                   <a href="index.php?page=Show/Usuarios/EditUser&user=<?php echo $row_usuario['ID_User']; ?>" type="button" class="btn btn-default btn-warning" aria-label="Excluir livro">
